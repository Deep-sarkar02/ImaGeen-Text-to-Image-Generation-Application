    ...
    return (
        <div className='flex items-center justify-between py-4'>
            ...
            <Link to='/' className='flex items-center gap-2'>
                <img className='w-8 sm:w-10' src={assets.logo_icon} alt="" />
                <span className='text-xl sm:text-2xl font-bold bg-gradient-to-r from-blue-600 to-teal-500 bg-clip-text text-transparent'>ImaGeen</span>
            </Link>
                    ...
                    user ?
                        <div className='flex items-center gap-2 sm:gap-3'>
                            <button onClick={() => navigate('/buy-credit')} className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700'>
                                <img className='w-2' src={assets.credit_star} alt="" />
